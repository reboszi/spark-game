...
async function runDiagnostic(type, button) {
  ...
  if(type==="power"){
    await typeLine("POWER DIAGNOSTICS","status-line",15); await typeLine("Primary power .................. DAMAGED","err",10); await typeLine("  Diagnostics .................. UNAVAILABLE","dim",10); await typeLine("  Required interface ........... REPAIR DRONE","unknown",10); await typeLine("Backup generator ............... HYDRAZINE THERMAL CELL","warn",10); await typeLine("  Generator state .............. RESTART REQUIRED","warn",10); await typeLine("  Hydrazine valve .............. BLOCKED","err",10); await typeLine("  Recovery method .............. EMERGENCY POWER FEEDBACK LOOP","warn",10); await typeLine("Emergency power ................ ONLINE","status-line",10); await typeLine("External generation ............ DETECTED","status-line",10); await typeLine("Source identification .......... UNKNOWN","unknown",10); await typeLine("Power storage .................. NOT AVAILABLE","err",10);
